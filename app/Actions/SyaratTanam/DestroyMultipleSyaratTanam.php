...
class DestroyMultipleSyaratTanam
{
    /**
     * Delete multiple syarat tanam by ids.
     *
     * If the request input 'ids' is not an array or empty, return back with error message.
     * Otherwise, begin a database transaction, delete the tanaman with the given ids,
    ...
    public function handle(Request $request): RedirectResponse
    {
        ...
        try {
            ...
            SyaratTanam::whereIn('id', $ids)->delete();
